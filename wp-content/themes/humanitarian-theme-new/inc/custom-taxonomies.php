...
/**
 * Insert default categories for HumanitarianBlog
 * Based on Website Structure document
 */
function humanitarian_insert_default_categories() {
    // Check if main categories already exist
    if (term_exists('technical-guides', 'category')) {
        return;
    }

    // Main Categories (Menu Items)
    $main_categories = [
        'technical-guides' => [
            'name' => 'Technical Guides',
            'description' => 'Practical day-to-day knowledge on project management, coordination, and field best practices.',
            'children' => [
                'strategy-development' => 'Strategy Development',
                'project-management-techniques' => 'Project Management Techniques',
                'humanitarian-aid-programming' => 'Humanitarian Aid Programming',
                'cross-cutting' => 'Cross Cutting',
            ]
        ],
        'aid-and-policy' => [
            'name' => 'Aid and Policy',
            'description' => 'Analysis and insights on humanitarian policy, aid effectiveness, and sector developments.',
            'children' => [
                'conflict' => 'Conflict',
                'culture' => 'Culture',
                'policy' => 'Policy',
        ...
        'environment-and-conflict' => [
            'name' => 'Environment and Conflict',
            'description' => 'Coverage of environmental issues in conflict zones and climate-related humanitarian challenges.',
            'children' => []
        ],
        'stories-from-the-field' => [
            'name' => 'Stories from the Field',
            'description' => 'First-hand accounts and narratives from humanitarian workers in the field.',
            'children' => [
                'water-sanitation-hygiene' => 'Water, Sanitation and Hygiene',
                'shelter' => 'Shelter',
                'pooled-funding' => 'Pooled Funding',
                ...
                'logistics-in-emergency' => 'Logistics in Emergency',
                'cash-assistance' => 'Cash Assistance',
                'emergency-relief' => 'Emergency Relief',
                'climate-resistance' => 'Climate Resistance',
            ]
        ],
    ];

    foreach ($main_categories as $slug => $data) {
        ...
        // Insert child categories if parent was created successfully
        if (!is_wp_error($parent_result) && !empty($data['children'])) {
...
// Disabled - categories will be created by setup script
// add_action('init', 'humanitarian_insert_default_categories', 2);
